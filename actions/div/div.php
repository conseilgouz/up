...
/**
 * Facilite la saisie de blocs DIV avec un éditeur wysiwyg
 *
...
class div extends Lomart\Plugin\Content\Up\Extension\Up
{
    ...
    public function run()
    {
        ...
        // code en retour
        $html[] = UpHelper::set_attr_tag($this,'div', $outer_div, $this->content);
